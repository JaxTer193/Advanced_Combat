...
public class SunBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:sun_block")
	public static final Block block = null;
	public SunBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 553);
	}
