...
public class UnstableFenceBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:unstable_fence")
	public static final Block block = null;
	public UnstableFenceBlock(AdvancedCombatModElements instance) {
		super(instance, 641);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("unstable_fence");
		}
