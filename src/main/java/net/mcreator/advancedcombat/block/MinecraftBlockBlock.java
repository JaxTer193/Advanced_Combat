...
public class MinecraftBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:minecraft_block")
	public static final Block block = null;
	public MinecraftBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 464);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minecraft_block");
		}
