...
public class LightBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:light_block")
	public static final Block block = null;
	public LightBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 616);
	}
