...
import net.mcreator.advancedcombat.item.PoopIngotItem;
...
public class PoopOreBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:poop_ore")
	public static final Block block = null;
	public PoopOreBlock(AdvancedCombatModElements instance) {
		super(instance, 421);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PoopIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("poop_ore", "poop_ore", blockAt -> {
