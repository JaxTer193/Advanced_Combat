...
public class AmathestBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:amathest_block")
	public static final Block block = null;
	public AmathestBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 574);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amathest_block");
		}
