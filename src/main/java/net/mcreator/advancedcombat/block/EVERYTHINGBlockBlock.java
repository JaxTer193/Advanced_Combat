...
public class EVERYTHINGBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:everything_block")
	public static final Block block = null;
	public EVERYTHINGBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("everything_block");
		}
