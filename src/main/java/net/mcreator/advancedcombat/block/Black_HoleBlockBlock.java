...
public class Black_HoleBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:black_hole_block")
	public static final Block block = null;
	public Black_HoleBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 53);
	}
