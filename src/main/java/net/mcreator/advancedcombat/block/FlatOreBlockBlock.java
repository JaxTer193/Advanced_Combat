...
public class FlatOreBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:flat_ore_block")
	public static final Block block = null;
	public FlatOreBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 443);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("flat_ore_block");
		}
