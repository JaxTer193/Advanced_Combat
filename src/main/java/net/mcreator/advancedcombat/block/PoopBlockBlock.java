...
public class PoopBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:poop_block")
	public static final Block block = null;
	public PoopBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 422);
	}
