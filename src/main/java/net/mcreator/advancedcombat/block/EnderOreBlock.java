...
import net.mcreator.advancedcombat.item.EnderIngotItem;
...
public class EnderOreBlock extends AdvancedCombatModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EnderIngotItem.block, (int) (1)));
		}
	}
	@Override
