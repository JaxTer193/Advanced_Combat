...
public class BloodFenceGateBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:blood_fence_gate")
	public static final Block block = null;
	public BloodFenceGateBlock(AdvancedCombatModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("blood_fence_gate");
		}
