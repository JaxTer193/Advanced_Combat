...
public class OrangeBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:orange_block")
	public static final Block block = null;
	public OrangeBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 55);
	}
