...
import net.mcreator.advancedcombat.item.SilverIngotItem;
...
public class SilverOreBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(AdvancedCombatModElements instance) {
		super(instance, 3);
	}
