...
public class UnstableFenceGateBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:unstable_fence_gate")
	public static final Block block = null;
	public UnstableFenceGateBlock(AdvancedCombatModElements instance) {
		super(instance, 642);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("unstable_fence_gate");
		}
