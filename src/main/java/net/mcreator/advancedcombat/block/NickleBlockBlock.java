...
public class NickleBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:nickle_block")
	public static final Block block = null;
	public NickleBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 595);
	}
