...
import net.mcreator.advancedcombat.item.OrangeItem;
...
public class OrangeOreBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:orange_ore")
	public static final Block block = null;
	public OrangeOreBlock(AdvancedCombatModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(OrangeItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("orange_ore", "orange_ore", blockAt -> {
