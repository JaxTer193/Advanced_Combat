...
public class CobaltBlockBlock extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:cobalt_block")
	public static final Block block = null;
	public CobaltBlockBlock(AdvancedCombatModElements instance) {
		super(instance, 401);
	}
