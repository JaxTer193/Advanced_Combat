...
public class PowerCellItem extends AdvancedCombatModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(AdvancedCombatItemGroup.tab).maxStackSize(16).rarity(Rarity.COMMON));
