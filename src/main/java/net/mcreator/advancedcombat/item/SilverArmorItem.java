...
public class SilverArmorItem extends AdvancedCombatModElements.ModElement {
	@ObjectHolder("advanced_combat:silver_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("advanced_combat:silver_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("advanced_combat:silver_armor_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "advanced_combat:textures/models/armor/silver_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
